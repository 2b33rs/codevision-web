...
const EditableMinStockCell = ({ product }: { product: StandardProduct }) => {
    ...
    <div className="flex items-center gap-2">
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <span title="Mindestbestand anpassen">
            <Pencil className="h-4 w-4 cursor-pointer text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white" />
          </span>
        </DropdownMenuTrigger>
        <DropdownMenuContent
          side="right"
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            ...
            <button
              onClick={() => {
                console.log(
                  `Neuer Mindestbestand für ${product.id}:`,
                  inputValue,
                );
              }}
